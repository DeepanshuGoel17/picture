	...
	for(int i=0;i<4;i++){
		...
		for(int j =0;j<siz;j=j+2){
		 ...
		 for(int  l= 0;l<li.size();l++){
			 ...
			 System.out.println( "this is list item::::: "+l+" ::::: "+li.get(l));
			 
		 }
		 count1 = count+count1;
		 count2= (int) (count2+Math.ceil(Math.sqrt(count)));
		System.out.println("SQRT of "+count1+" ::::"+Math.ceil(Math.sqrt(count)));
...
public static void main(String args[]){
	int x;
	String [] s ={"8 8","4 3","5 8","7 3","8 6","7 8","5 5","6 5"};
	int siz =8;
	x= minimalCost(siz,s);
